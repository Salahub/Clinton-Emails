...
\teaser{
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=0.2\textheight]{EmailSentRecdSept11toNov23} &
  \includegraphics[height=0.2\textheight]{InnerCircleSept11ToNov23} \\
  &\\
...
Similarly, the length of each spoke is inversely proportional to the volume of email so 
%Whenever the difference in volume is great enough,  correspondents are separated into two groups: 
those correspondents having the greatest volume will 
%with the greatest correspondence 
have shorter spokes visually placing them ``closer'' to Clinton.  
As \autoref{fig:InnerCircleAll} shows shows, Clinton's closest inner circle are her closest aides Huma Abedin, Cheryl Mills, and Jake Sullivan.
